    ...
    <div className="ma-w-6xl mx-auto px-4 mt-6">
        <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <input value={query} onChange={e => onQueryChange(e.target.value)} placeholder="Search goals..." className="w-full sm:max-w-sm border border-gray-200 rounded-lg px-3 py-2 text-sm outline-none focus:ring-2 foucs:ring-gray-200"/>
                <div className="flex items-center gap-2">
                    ...
                    className={`px-3 py-2 rounded-lg text-sm border cursor-pointer ${
                        ...
                        :
                        "bg-white text-gray-799 border-gray-200"
                    }`}
                    >
                        All
                    </button>
